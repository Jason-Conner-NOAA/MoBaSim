#' Prepare input data for MoBaSim Project
#' 
#' Pulls data from file sources and RACEBASE and processes for use in the Model-based Simulation Project.
#' 
#' This truncated data pull reduces the timespan from 1995-2019 to 2015-2019, to reduce computing times
#' during preliminary runs. 
#' 
#' Outputs a list *EBSbundle* containing necessary objects for running OMs.
...
load(here::here("data","Predict_data.rda"))
EBSstrata <- st_read(dsn=here::here("shapefiles"), layer="EBSstrata")

EBS <- getRacebase(2015:2019,'EBS_SHELF') 
EBSdata <- sumHaul(EBS)
